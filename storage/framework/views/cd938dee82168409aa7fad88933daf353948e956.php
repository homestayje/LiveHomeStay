<tr>
    ...
    <td width="2%">
        ...
        <?php if($booking->status == 'paid' || $booking->status == 'unpaid' || $booking->status == 'processing' || $booking->status == 'draft'): ?>
            <a href="<?php echo e(route('booking.cancel',['code'=>$booking->code])); ?>" onclick="return confirm('Are you sure you want to cancel booking?')" class="btn btn-xs btn-primary btn-info-booking open-new-window mt-1">
                <i class="fa fa-trash"></i><?php echo e(__("Cancel")); ?>
...
<?php /**PATH /var/www/html/modules/Hotel/Views/frontend/bookingHistory/loop.blade.php ENDPATH**/ ?>