    ...
    <div class="bravo-list-space-related product-card-carousel-block product-card-carousel-v5 mb-3">
        <div class="space-1">
            ...
            <div class="travel-slick-carousel u-slick u-slick--equal-height u-slick--gutters-3"
                ...
                <?php $__currentLoopData = $flight_related; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="js-slide mt-5">
                        <?php echo $__env->make('Flight::frontend.layouts.search.loop-grid',['row'=>$item,'include_param'=>0], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
    </div>
<?php endif; ?><?php /**PATH /var/www/html/modules/Flight/Views/frontend/layouts/details/space-related.blade.php ENDPATH**/ ?>