                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <select name="surrounding[<?php echo e($category->id); ?>][<?php echo e($key); ?>][type]"
                                                        class="form-control">
                                                    <option <?php if($item['type'] !='m' ||  $item['type'] !='km'): ?> selected
                                                           <?php endif; ?> value="m">select </option>    
...
<?php endif; ?>
<?php /**PATH /var/www/html/modules/Hotel/Views/admin/hotel/surrounding.blade.php ENDPATH**/ ?>