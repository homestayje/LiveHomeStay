    ...
    <div class="bravo-vendor-form-register py-5 <?php if(!empty($layout)): ?> <?php echo e($layout); ?> <?php endif; ?>">
        <div class="row">
            <div class="col-12 col-lg-5">
                <h1><?php echo e(__("Success Approved Become Vendor")); ?></h1>
            </div>
...
<?php /**PATH /var/www/html/modules/Vendor/Views/frontend/blocks/form-register/request_success_approved.blade.php ENDPATH**/ ?>