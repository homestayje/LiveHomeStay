            ...
            <div class="border border-color-7 rounded mb-5">
                ...
                <div class="form-book" :class="{'d-none':enquiry_type!='book'}">
                    <div class="p-4">
                        ...
                        <div class="mb-4">
                            <div class="border-bottom border-width-2 border-color-1" data-format="<?php echo e(get_moment_date_format()); ?>">
...
<?php /**PATH /var/www/html/modules/Flight/Views/frontend/layouts/details/space-form-book.blade.php ENDPATH**/ ?>