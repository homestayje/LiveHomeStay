<tr>
    ...
    <td>
        <?php $commission = $booking->commission ?>
        <?php if(!empty($commission)): ?>
            <?php echo e(format_money($commission)); ?>
    ...
    <td width="2%">
        <?php if($service = $booking->service): ?>
            ...
            <?php if ($__env->exists($service->checkout_booking_detail_modal_file ?? '')) echo $__env->make($service->checkout_booking_detail_modal_file ?? '', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php endif; ?>
...
<?php /**PATH /var/www/html/modules/Flight/Views/frontend/bookingReport/loop.blade.php ENDPATH**/ ?>