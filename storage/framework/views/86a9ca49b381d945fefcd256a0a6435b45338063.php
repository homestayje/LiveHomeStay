...
<?php $__env->startSection('content'); ?>
    <h2 class="title-bar">
        <?php echo e(__("Settings")); ?>
         ...
         <a href="<?php echo e(route('user.delete_user',$dataUser->id)); ?>" class="btn-change-password ml-1" style="background: #cc4f4f;" onclick="return confirm('Are you sure you want to delete your account ?')"><?php echo e(__("Delete Account")); ?></a>
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input type="text" value="<?php echo e(old('birthday',$dataUser->birthday? DateTime::createFromFormat('Y-m-d', $dataUser->birthday)->format('d/m/Y') :'')); ?>" name="birthday" id="birthday" placeholder="<?php echo e(__("Birthday")); ?>" class="form-control">
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/modules/User/Views/frontend/profile.blade.php ENDPATH**/ ?>