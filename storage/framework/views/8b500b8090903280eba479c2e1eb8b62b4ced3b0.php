<div class="panel">
    <div class="panel-title"><strong><?php echo e(__("Homestay Content")); ?></strong></div>
    <div class="panel-body">
        <div class="form-group">
            <label><?php echo e(__("Title")); ?></label>
            <input type="text" value="<?php echo clean($translation->title); ?>" placeholder="<?php echo e(__("Name of the homestay")); ?>" name="title" class="form-control">
        </div>
        <div class="form-group">
...
<div class="panel">
    <div class="panel-title"><strong><?php echo e(__("Homestay Policy")); ?></strong></div>
    <div class="panel-body">
        <?php if(is_default_lang()): ?>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label><?php echo e(__("Homestay rating standard")); ?></label>
                        <input type="number" min="1" max="5" value="<?php echo e($row->star_rate); ?>" placeholder="<?php echo e(__("Eg: 5")); ?>" name="star_rate" class="form-control">
                    </div>
                </div>
            </div>
        <?php endif; ?>
...
<?php /**PATH /var/www/html/modules/Hotel/Views/admin/hotel/content.blade.php ENDPATH**/ ?>