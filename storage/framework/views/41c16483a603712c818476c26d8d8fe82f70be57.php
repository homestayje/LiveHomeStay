<?php if(count($hotel_related) > 0): ?>
    <div class="bravo-list-hotel-related-widget">
        <h3 class="heading"><?php echo e(__("Related Homestay")); ?></h3>
        <div class="list-item">
...
<?php endif; ?><?php /**PATH /var/www/html/modules/Hotel/Views/frontend/layouts/details/hotel-related-list.blade.php ENDPATH**/ ?>