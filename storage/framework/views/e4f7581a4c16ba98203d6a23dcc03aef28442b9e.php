                    ...
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <select name="search_open_tab" class="form-control" >
                                <option value="current_tab" <?php echo e(($settings['search_open_tab'] ?? '') == 'current_tab' ? 'selected' : ''); ?>><?php echo e(__("Current Tab")); ?></option>
                                <option value="new_tab" <?php echo e(($settings['search_open_tab'] ?? '') == 'new_tab' ? 'selected' : ''); ?>><?php echo e(__('Open New Tab')); ?></option>
                            </select>
                        </div>
                    </div>
                </div>
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-controls">
                            <input type="text" name="map_lat_default" value="<?php echo e($settings['map_lat_default'] ?? ''); ?>" class="form-control" placeholder="21.030513">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <label><?php echo e(__("Map Lng Default")); ?></label>
                        <div class="form-controls">
                            <input type="text" name="map_lng_default" value="<?php echo e($settings['map_lng_default'] ?? ''); ?>" class="form-control" placeholder="105.840565">
                        </div>
                    </div>
                ...
                <div class="form-group mt-3">
                    ...
                    <div class="form-controls">
                        <select name="map_clustering" class="form-control" >
                            <option value="" <?php echo e(($settings['map_clustering'] ?? '') == '' ? 'selected' : ''); ?>><?php echo e(__("Off")); ?></option>
                            <option value="on" <?php echo e(($settings['map_clustering'] ?? '') == 'on' ? 'selected' : ''); ?>><?php echo e(__('On')); ?></option>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group mt-3">
                    ...
                    <div class="form-controls">
                        <select name="map_fit_bounds" class="form-control" >
                            <option value="" <?php echo e(($settings['map_fit_bounds'] ?? '') == '' ? 'selected' : ''); ?>><?php echo e(__("Off")); ?></option>
                            <option value="on" <?php echo e(($settings['map_fit_bounds'] ?? '') == 'on' ? 'selected' : ''); ?>><?php echo e(__('On')); ?></option>
                        </select>
                    </div>
                </div>
            </div>
...
<?php /**PATH /var/www/html/modules/Core/Views/admin/settings/groups/advance.blade.php ENDPATH**/ ?>