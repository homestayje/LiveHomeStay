<div class="sidebar border border-color-1 rounded-xs">
    <div class="p-4 mb-1">
        <form action="<?php echo e(route("flight.search")); ?>" class="bravo_form" method="get">
            ...
            <?php if(!empty($search_fields)): ?>
                <?php $__currentLoopData = $search_fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php switch($field['field']):
                        ...
                        <?php case ('attr'): ?>
                            <?php echo $__env->make('Flight::frontend.layouts.search.fields.attr', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        <?php break; ?>
                        <?php case ('guests'): ?>
...
</div><?php /**PATH /var/www/html/modules/Flight/Views/frontend/layouts/search/form-search-vertical.blade.php ENDPATH**/ ?>