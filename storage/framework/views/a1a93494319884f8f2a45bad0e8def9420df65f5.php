    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-between mb20">
            ...
            <div class="title-actions">
                ...
                <a href="<?php echo e(route('hotel.admin.edit',['id'=>$hotel->id])); ?>" class="btn btn-info btn-xs"><i class="fa fa-hand-o-right"></i> <?php echo e(__("Back to homestay")); ?></a>
            </div>
        </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/modules/Hotel/Views/admin/room/index.blade.php ENDPATH**/ ?>