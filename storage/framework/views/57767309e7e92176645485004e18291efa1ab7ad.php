    ...
    <div class="col-lg-9 col-md-12">
        <div class="bravo-list-item">
            <div class="topbar-search">
                <h2 class="text">
                    <?php if($rows->total() > 1): ?>
                        <?php echo e(__(":count homestays found",['count'=>$rows->total()])); ?>

                    <?php else: ?>
                        <?php echo e(__(":count homestay found",['count'=>$rows->total()])); ?>
            ...
            <div class="list-item">
                <div class="row">
                    ...
                    <?php else: ?>
                        <div class="col-lg-12">
                            <?php echo e(__("Homestay not found")); ?>
            ...
            <div class="bravo-pagination">
                ...
                <?php if($rows->total() > 0): ?>
                    <span class="count-string"><?php echo e(__("Showing :from - :to of :total Homestay",["from"=>$rows->firstItem(),"to"=>$rows->lastItem(),"total"=>$rows->total()])); ?></span>
                <?php endif; ?>
            </div>
        </div>
    </div>
...
</script><?php /**PATH /var/www/html/modules/Hotel/Views/frontend/layouts/search/list-item.blade.php ENDPATH**/ ?>