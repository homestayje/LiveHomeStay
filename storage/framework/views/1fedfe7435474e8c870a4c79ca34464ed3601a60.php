            ...
            <div class="form-add-service">
                <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                    ...
                    <?php if(is_default_lang()): ?>
                        ...
                        <a data-toggle="tab" href="#nav-cancellation-policy" aria-selected="false"><?php echo e(__("5. Cancellation Policy")); ?></a>
                ...
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <?php if(is_default_lang()): ?>
                        ...
                        <div class="tab-pane fade" id="nav-cancellation-policy">
                            <?php echo $__env->make('Hotel::admin/hotel/cancellation-policy', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                       </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/modules/Hotel/Views/frontend/vendorHotel/detail.blade.php ENDPATH**/ ?>