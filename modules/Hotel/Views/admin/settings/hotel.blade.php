        ...
        <div class="panel">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="" >{{__("Layout Item HomestayIn Page Search")}}</label>
                            <div class="form-controls">
...
@if(is_default_lang())
    ...
    <div class="row">
        <div class="col-sm-4">
            ...
            <p class="form-group-desc">{{__('Config review for homestay')}}</p>
        </div>
        <div class="col-sm-8">
            <div class="panel">
                <div class="panel-body">
                    <div class="form-group">
                        <label class="" >{{__("Enable review system for Homestay?")}}</label>
                        <div class="form-controls">
                            ...
                            <br>
                            <small class="form-text text-muted">{{__("Turn on the mode for reviewing homestay")}}</small>
                        </div>
                    </div>
                    <div class="form-group" data-condition="hotel_enable_review:is(1)">
                        <label class="" >{{__("Customer must book a homestay before writing a review?")}}</label>
                        <div class="form-controls">
...
@if(is_default_lang())
    ...
    <div class="row">
        <div class="col-sm-4">
            ...
            <p class="form-group-desc">{{__('Config buyer fees for homestay')}}</p>
        </div>
        <div class="col-sm-8">
            <div class="panel">
                <div class="panel-body">
...
@if(is_default_lang())
    ...
    <div class="row">
        <div class="col-sm-4">
            ...
            <p class="form-group-desc">{{__('Vendor config for homestay')}}</p>
        </div>
        <div class="col-sm-8">
            <div class="panel">
                <div class="panel-body">
                    <div class="form-group">
                        <label class="" >{{__("Homestay created by vendor must be approved by admin")}}</label>
                        <div class="form-controls">
...
<div class="row">
    <div class="col-sm-4">
        <h3 class="form-group-title">{{__("Disable homestay module?")}}</h3>
    </div>
    <div class="col-sm-8">
        <div class="panel">
            <div class="panel-title"><strong>{{__("Disable homestay module")}}</strong></div>
            <div class="panel-body">
                <div class="form-group">
                    <div class="form-controls">
