...
@if(!empty($services) and $services->total())
    <div class="bravo-profile-list-services">
        @include('Hotel::frontend.blocks.list-hotel.index', ['rows'=>$services,'style_list'=>'normal','desc'=>' ','title'=>!empty($view_all) ? __('Homestay by :name',['name'=>$user->first_name]) :'','col'=>4])
