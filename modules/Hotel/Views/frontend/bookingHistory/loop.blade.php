<tr>
    ...
    <td width="2%">
        ...
        @if($booking->status == 'paid' || $booking->status == 'unpaid' || $booking->status == 'processing' || $booking->status == 'draft')
            <a href="{{route('booking.cancel',['code'=>$booking->code])}}" onclick="return confirm('Are you sure you want to cancel booking?')" class="btn btn-xs btn-primary btn-info-booking open-new-window mt-1">
