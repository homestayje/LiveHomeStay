...
@section('content')
    <h2 class="title-bar no-border-bottom">
        {{$row->id ? __('Edit: ').$row->title : __('Add new homestayee')}}
        @if($row->id)
            <div class="title-action">
                <a class="btn btn-info" href="{{route('hotel.vendor.room.index',['hotel_id'=>$row->id])}}">
                    <i class="fa fa-hand-o-right"></i> {{__("Manage")}}
                </a>
            ...
            <div class="form-add-service">
                <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                    ...
                    @if(is_default_lang())
                        ...
                        <a data-toggle="tab" href="#nav-cancellation-policy" aria-selected="false">{{__("5. Cancellation Policy")}}</a>
                ...
                <div class="tab-content" id="nav-tabContent">
                    ...
                    @if(is_default_lang())
                        ...
                        <div class="tab-pane fade" id="nav-cancellation-policy">
                            @include('Hotel::admin/hotel/cancellation-policy')
                       </div>
