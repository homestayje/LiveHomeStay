...
Route::group(['prefix'=>'user','middleware' => ['auth','verified']],function(){
    ...
    Route::get('/profile/{id}/delete-user','UserController@deleteUser')->name("user.delete_user");
    ...
    Route::get('/bank-info','UserController@bankInfo')->name("user.bank_info");
    Route::post('/bank-info','UserController@updateBankInfo')->name("user.account_info_update");
