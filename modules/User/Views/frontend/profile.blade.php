...
@section('content')
    <h2 class="title-bar">
        {{__("Settings")}}
         <a href="{{route('user.delete_user',$dataUser->id)}}" class="btn-change-password ml-1" style="background: #cc4f4f;" onclick="return confirm('Are you sure you want to delete your account ?')">{{__("Delete Account")}}</a>
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('birthday',$dataUser->birthday? DateTime::createFromFormat('Y-m-d', $dataUser->birthday)->format('d/m/Y') :'') }}" name="birthday" id="birthday" placeholder="{{__("Birthday")}}" class="form-control">
