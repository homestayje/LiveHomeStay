...
class RouterServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $moduleNamespace      = 'Plugins\ToyyibPay\Controllers';
    protected $adminModuleNamespace = 'Plugins\ToyyibPay\Admin';
    ...
    protected function mapAdminRoutes()
    {
        Route::middleware([
            'web',
            'dashboard'
        ])->namespace($this->adminModuleNamespace)->prefix('admin/module/ToyyibPay')->group(__DIR__ . '/Routes/admin.php');
    }
